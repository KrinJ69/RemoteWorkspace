...
@OnlyIn(Dist.CLIENT)
public class AccessoriesGuiGuiWindow extends ContainerScreen<AccessoriesGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public AccessoriesGuiGuiWindow(AccessoriesGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
