...
public class ArrowOfFlameItem extends AggregateModElements.ModElement {
	@ObjectHolder("aggregate:arrow_of_flame")
	public static final Item block = null;
	public ArrowOfFlameItem(AggregateModElements instance) {
		super(instance, 80);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("arrow_of_flame");
		}
