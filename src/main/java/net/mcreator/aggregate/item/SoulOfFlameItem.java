...
public class SoulOfFlameItem extends AggregateModElements.ModElement {
	@ObjectHolder("aggregate:soul_of_flame")
	public static final Item block = null;
	public SoulOfFlameItem(AggregateModElements instance) {
		super(instance, 4);
	}
