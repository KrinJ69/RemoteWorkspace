...
import net.mcreator.aggregate.procedures.BackPackRightClickedInAirProcedure;
import net.mcreator.aggregate.itemgroup.AggregateItemsItemGroup;
import net.mcreator.aggregate.gui.BackPackGuiGuiWindow;
...
public class BackPackItem extends AggregateModElements.ModElement {
	@ObjectHolder("aggregate:back_pack")
	public static final Item block = null;
	public BackPackItem(AggregateModElements instance) {
		super(instance, 86);
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(AggregateItemsItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
